        ...
        if (document.querySelector(".burger")) {
            ...
            document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".burger")) {
                    ...
                    let menuBurger = document.querySelector(".navigate-header");
                    menuBurger.classList.toggle("open-menu");
                    let menuBurgerBg = document.querySelector(".burger-background");
                    menuBurgerBg.classList.toggle("open-menu");
                    const menuBurgerWidth = menuBurger.offsetWidth;
                    const translateX = isLeft ? -menuBurgerWidth : 0;
                    menuBurger.style.transform = `translateX(` + `${translateX}px)`;
                    menuBurger.style.transition = "transform 0.3s ease-in";
                    isLeft = !isLeft;
                }
            }));
        }
